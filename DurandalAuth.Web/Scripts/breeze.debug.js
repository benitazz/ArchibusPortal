...
var Validator = (function () {
    ...
    **/
    ...
    @example
        ...
        var validator = Validator.maxLength({ maxLength: 5, displayName: "CityNameLookup" });
    ...
    **/
    ...
    @example
        var v0 = Validator.maxLength({ maxLength: 5, displayName: "CityNameLookup" });
    ...
    **/
    ...
    @example
        ...
        var personType = em.metadataStore.getEntityType("Individual");
        var creditCardProperty = personType.getProperty("creditCard");
        // Validates that the value of the Individual.creditCard property is credit card.
    ...
    **/
    ...
    @example
        ...
        // Validates that the value of the Individual.email property is an email address.
    ...
    **/
    ...
    @example
        ...
        // Validates that the value of the Individual.website property is a URL.
...
var CompositeOrderByClause = (function () {
    ...
    proto.toODataFragment = function (entityType) {
        ...
        // should return something like CompanyName,Address/CityNameLookup desc
        return strings.join(',');
    };
